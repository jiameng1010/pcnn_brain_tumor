...
class PoolingLayer_pn:
    ...
    def get_layer(self,network,use_fps,startidx = None,is_subsampling = False):
        ...
        pooled_normals_pl = tf.gather_nd(self.block_elm.normals_pl, mask)

        if (is_subsampling):
            return pooled_points_pl,pooled_normals_pl,tf.gather_nd(network,mask)
        else:
            ...
            return pooled_points_pl,pooled_normals_pl,pooled_network
