...
class ConvLayer_dual:
    ...
    def get_layer(self, probe_points, functions_pl, with_bn, bn_decay,interpolation,with_Relu = True):
        ...
        with tf.variable_scope(self.scope, reuse=tf.AUTO_REUSE) as sc:
            ...
            if (with_bn):
                ...
                outputs2 = tf_util.batch_norm_template(outputs2, self.is_training, 'bn', [0, 1], bn_decay)
            if (with_Relu):
